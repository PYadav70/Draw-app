          ...
          <div className="w-full md:w-1/2 md:pr-12">
            ...
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
              <button
                ...
                className="px-8 py-3 rounded-lg bg-blue-500 hover:bg-blue-600 text-white font-semibold text-lg transition-colors shadow-lg hover:shadow-xl transform hover:-translate-y-1 duration-300"
              >
                Start Drawing Now
              </button>
